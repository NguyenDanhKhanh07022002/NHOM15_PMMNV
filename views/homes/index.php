                        ...
                        <div class="banner-img-home">
                            <a href="#">
                                <div class="img_banner_home"
                                    style="background-image: url(../backend/assets/uploads/<?php echo $compo_img['component_img'] ?>)">
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="product-item product-resize">
                        <div class="product-img image-resize">
                            <a href="<?php echo $product_link; ?>" title="<?php echo $product_title; ?>">
                                <img alt=" <?php echo $product_title; ?> "
                            ...
                            <div class="hover-mask">
                                <div class="inner-mask">
                                    <a class="add-view-cart btn-cart add-cart " data-variant="1007783439"
                                        href="them-vao-gio-hang/<?php echo $product['id']; ?>" title="Thêm vào giỏ">
                                        <i class="fa fa-bars"></i>
                                        Thêm vào giỏ
                                    </a>
                                    <ul class="add-to-links">
                                        <li><a href="<?php echo $product_link; ?>" class="mask-view"
                                                data-handle="/products/phuc-bon-tu" title="Xem nhanh"><i
                                                    class="fa fa-eye"></i></a></li>
                                        <li><a href="<?php echo $product_link; ?>" class="" title="Xem chi tiết"><i
                        ...
                        <div class="product-detail">
                            <h3 class="pro-name"><a href="<?php echo $product_link; ?>"
                                    title="<?php echo $product_title; ?>"><?php echo $product_title; ?><?php ?> </a>
                            </h3>
                            <p class="pro-vendor">
            ...
            <ul class="list-gallery  ">
                ...
                <li class="col-lg-3 col-md-3 col-sm-6 col-xs-6 img_1 wow slideInLeft">
                    <a class="fancybox" rel="group"
                        href="../backend/assets/uploads/<?php echo $compo_img['store_img'] ?>">
                        <div class="bkg-fancybox"
                            style="background-image:url(../backend/assets/uploads/<?php echo $compo_img['store_img'] ?>);background-size:cover;cursor: pointer;">
                        </div>
                    </a>
                </li>
                <?php endforeach; ?>
